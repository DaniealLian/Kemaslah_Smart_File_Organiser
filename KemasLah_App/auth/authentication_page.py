...
class LoginPage(QWidget):
    ...
    skip_login_clicked = pyqtSignal()     # Signal for skipping login (guest mode)
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.login_page = LoginPage(self.stack, None, None) 
    ...
    def update_all_pages(self, lang_code):
        """Updates translations only for the widgets currently in the auth stack"""
